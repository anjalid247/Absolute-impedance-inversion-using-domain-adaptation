...
## Data
Please download the processed multi-attribute input data of Marmousi2 and SEAM subsalt model from synthetic data [folder](https://drive.google.com/drive/folders/1kZqchGNgeM-voEJgsPATBdSPZjQIxnDu?usp=share_link)
