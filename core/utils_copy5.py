...
class CustomModule(nn.Module):
    def __init__(self):
        ...
        self.gru1=nn.GRU(5, 200, 3,batch_first=True, bidirectional=True, dropout=0.2)
...
class Descriminator(nn.Module):
    def __init__(self):
        ...
        self.ln1 =nn.Linear(3505,1000)
        self.ln2 = nn.Linear(1000,100)
        self.ln3 = nn.Linear(100,10)
